...
1. Complete Phase 0 baseline and keep it as the comparison point.
2. Implement density modes and inventory-focused mode.
3. Implement deterministic 10k mock rows and virtual scrolling.
4. Implement filters, grouping, sorting, and bulk preview in prototype.
5. Define and implement SQLite-backed inventory query contract.
6. Update generated review HTML to avoid unbounded JSON.
7. Run forensic review QA and Phase 9 performance validation.
