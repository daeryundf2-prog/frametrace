...
- [PASS] case manifest: `.omo/evidence/frametrace-production-hardening-review-plan/task-04-audit-chain-required/stop-hook-direct-verification-6/manual-qa/recovered-filesystem-case/case.json`
- [PASS] case database: `.omo/evidence/frametrace-production-hardening-review-plan/task-04-audit-chain-required/stop-hook-direct-verification-6/manual-qa/recovered-filesystem-case/db/case.db`
- [PASS] video JSON index: `.omo/evidence/frametrace-production-hardening-review-plan/task-04-audit-chain-required/stop-hook-direct-verification-6/manual-qa/recovered-filesystem-case/db/video_index.json`
- [PASS] video JSONL index: `.omo/evidence/frametrace-production-hardening-review-plan/task-04-audit-chain-required/stop-hook-direct-verification-6/manual-qa/recovered-filesystem-case/db/videos.jsonl`
- [PASS] video path TSV: `.omo/evidence/frametrace-production-hardening-review-plan/task-04-audit-chain-required/stop-hook-direct-verification-6/manual-qa/recovered-filesystem-case/db/video_paths.tsv`
- [PASS] case report: `.omo/evidence/frametrace-production-hardening-review-plan/task-04-audit-chain-required/stop-hook-direct-verification-6/manual-qa/recovered-filesystem-case/reports/case-report.html`
