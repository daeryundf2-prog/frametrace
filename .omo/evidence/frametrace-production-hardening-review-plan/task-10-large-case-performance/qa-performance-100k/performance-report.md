...
- Rows: 100000
- Elapsed ms: 4902
- Rows per minute: 1223990 (target: 50000)
- Max indexed query ms: 4 (target: 2000)
- Query plan full scans: 0
- Max RSS: 20.42 MiB (target: 1536.00 MiB)
- Average CPU: 98.53% (target: 95%, enforced: false)
- Resource samples: 74
- Database: `.omo/evidence/frametrace-production-hardening-review-plan/task-10-large-case-performance/qa-performance-100k/db/case.db`

## Large-Case Survival

- Report generation ms: 41
- Review bundle generation ms: 27
- Max inventory query ms: 204 (target: 2000)
- Compatibility JSONL rows: 100000 (12931034/min)
- Compatibility TSV rows: 100000 (15000000/min)
...
| --- | ---: | ---: | --- |
| Max RSS | 20.42 MiB | 1536.00 MiB | PASS |
| Average CPU | 98.53% | 95% | MEASURED_NOT_GATED |
