...
- Rows: 100000
- Elapsed ms: 4959
- Rows per minute: 1209921 (target: 50000)
- Max indexed query ms: 4 (target: 2000)
- Query plan full scans: 0
- Max RSS: 9.22 MiB (target: 2560.00 MiB)
- Average CPU: 99.22% (target: 95%, enforced: false)
- Resource samples: 47
- Database: `.omo/evidence/frametrace-production-hardening-review-plan/task-02-typed-release-gates/manual-qa/out-malformed-json/performance/db/case.db`

## Resource Metrics

| Metric | Value | Target | Status |
| --- | ---: | ---: | --- |
| Max RSS | 9.22 MiB | 2560.00 MiB | PASS |
| Average CPU | 99.22% | 95% | MEASURED_NOT_GATED |
