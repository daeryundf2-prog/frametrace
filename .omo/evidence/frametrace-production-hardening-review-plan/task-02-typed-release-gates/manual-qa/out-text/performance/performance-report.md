...
- Rows: 100000
- Elapsed ms: 4931
- Rows per minute: 1216791 (target: 50000)
- Max indexed query ms: 4 (target: 2000)
- Query plan full scans: 0
- Max RSS: 9.11 MiB (target: 2560.00 MiB)
- Average CPU: 97.38% (target: 95%, enforced: false)
- Resource samples: 47
- Database: `.omo/evidence/frametrace-production-hardening-review-plan/task-02-typed-release-gates/manual-qa/out-text/performance/db/case.db`

## Resource Metrics

| Metric | Value | Target | Status |
| --- | ---: | ---: | --- |
| Max RSS | 9.11 MiB | 2560.00 MiB | PASS |
| Average CPU | 97.38% | 95% | MEASURED_NOT_GATED |
