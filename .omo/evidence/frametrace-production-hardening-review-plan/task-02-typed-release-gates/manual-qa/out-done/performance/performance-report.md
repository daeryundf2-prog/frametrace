...
- Max RSS: 9.14 MiB (target: 2560.00 MiB)
- Average CPU: 99.57% (target: 95%, enforced: false)
- Resource samples: 46
- Database: `.omo/evidence/frametrace-production-hardening-review-plan/task-02-typed-release-gates/manual-qa/out-done/performance/db/case.db`

## Resource Metrics

| Metric | Value | Target | Status |
| --- | ---: | ---: | --- |
| Max RSS | 9.14 MiB | 2560.00 MiB | PASS |
| Average CPU | 99.57% | 95% | MEASURED_NOT_GATED |
