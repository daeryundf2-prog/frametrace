...
- Rows: 100000
- Elapsed ms: 4918
- Rows per minute: 1220008 (target: 50000)
- Max indexed query ms: 4 (target: 2000)
- Query plan full scans: 0
- Max RSS: 9.20 MiB (target: 2560.00 MiB)
- Average CPU: 99.27% (target: 95%, enforced: false)
- Resource samples: 46
- Database: `.omo/evidence/frametrace-production-hardening-review-plan/task-02-typed-release-gates/manual-qa/out-stale/performance/db/case.db`

## Resource Metrics

| Metric | Value | Target | Status |
| --- | ---: | ---: | --- |
| Max RSS | 9.20 MiB | 2560.00 MiB | PASS |
| Average CPU | 99.27% | 95% | MEASURED_NOT_GATED |
